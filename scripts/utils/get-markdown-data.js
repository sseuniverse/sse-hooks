...
const hooksSrcDir = path.resolve("./packages/hooks/src");
...
export function getHookDocData(hook) {
  // Path: ./generated/typedoc/useBoolean/useBoolean/functions/useBoolean.md
...
export function getTypeAliasesData(hook) {
  return (
    hook.types.map((t) => {
      // Path: ./generated/typedoc/useBoolean/useBoolean/types/SomeType.md
      const pathname = path.join(
        typedocDir,
        hook.modulePath,
        "types",
