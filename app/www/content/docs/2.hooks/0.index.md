...
::card-group
  ...
  ---
  Custom hook that tracks the [`screen`](https://developer.
  :::
...
::card-group
  ...
  to: /docs/hooks/use-history-state
  ---
...
::card-group
  ...
  to: /docs/hooks/use-deep-compare-effect
  ---
...
::card-group
  ...
  ---
  Custom hook that reads a value from [`localStorage`](https://developer.
  :::
...
::card-group
  ...
  to: /docs/hooks/use-callback-ref
  ---
...
to a MediaStream track.
  ...
  to: /docs/hooks/use-search-with-suggestions
  ---
