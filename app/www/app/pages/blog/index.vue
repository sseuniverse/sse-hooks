      ...
      <UContainer>
        <div class="border-x border-default gap-0!">
          ...
          >
            ...
            >
              <div
                class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 flex-1 min-w-0"
              >
                <div class="flex-1 min-w-0">
                  ...
                  <h2
                    class="font-medium text-highlighted group-hover:text-primary transition-colors duration-200 truncate sm:text-base"
                  >
                    {{ post.title }}
                  </h2>
                  <p
                    class="text-sm text-muted mt-1 line-clamp-2 sm:line-clamp-1"
                  >
                    {{ post.description }}
                  </p>
                </div>
              ...
              <div
                class="flex items-center justify-between sm:justify-end gap-3 sm:gap-2 shrink-0"
              >
                <UAvatarGroup
